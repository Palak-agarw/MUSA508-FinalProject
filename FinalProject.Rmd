...
ggplot() +
  ...
  scale_fill_manual(values = palatte_nlcd, name="WUI Type", labels=c("Evergreen Needleleaf", "Evergreen Broadleaf", "Deciduous Needleleaf", "Deciduous Broadleaf", "Mixed Forests", "Closed Shrublands", "Open Shrubland", "Woody Savannas", "Savannas", "Grassland", "Permanent Wetland", "Cropland", "Urban and Built-up Lands", "Cropland/Natural Vegetation Mosaics", "Permanent Snow and Ice", "Water Bodies")) +

  labs(title="National Land Cover Data and Fire",
       subtitle = "Red outline denotes fire perimeters 2014-2018") +
